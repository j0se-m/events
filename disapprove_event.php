...
// Function to handle event disapproval
function disapproveEvent($event_id) {
    ...
    if ($stmt->execute()) {
        ...
        echo "Error disapproving event: " . $stmt->error;
        return false;
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['event_id'])) {
    ...
    if (disapproveEvent($event_id)) {
        $_SESSION['toast_message'] = "Event disapproved successfully.";
        header("Location: approved.php");
        exit();
    }
}
